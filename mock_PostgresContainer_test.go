...
func (_m *MockPostgresContainer) Terminate(_a0 context.Context, _a1 ...testcontainers.TerminateOption) error {
...
//   - _a0 context.Context
//   - _a1 ...testcontainers.TerminateOption
func (_e *MockPostgresContainer_Expecter) Terminate(_a0 interface{}, _a1 ...interface{}) *MockPostgresContainer_Terminate_Call {
	return &MockPostgresContainer_Terminate_Call{Call: _e.mock.On("Terminate",
		append([]interface{}{_a0}, _a1...)...)}
}

func (_c *MockPostgresContainer_Terminate_Call) Run(run func(_a0 context.Context, _a1 ...testcontainers.TerminateOption)) *MockPostgresContainer_Terminate_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockPostgresContainer_Terminate_Call) RunAndReturn(run func(context.Context, ...testcontainers.TerminateOption) error) *MockPostgresContainer_Terminate_Call {
	_c.Call.Return(run)
	return _c
}
